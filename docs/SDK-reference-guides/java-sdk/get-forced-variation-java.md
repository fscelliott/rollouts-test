...
slug: "get-forced-variation-java"
hidden: false
createdAt: "2019-09-12T14:18:17.329Z"
updatedAt: "2019-09-12T21:12:17.988Z"
---
Returns the forced variation set by [Set Forced Variation](doc:set-forced-variation-java), or `null` if no variation was forced.
...
[/block]
Forced bucketing variations take precedence over whitelisted variations, variations saved in a User Profile Service (if one exists), and the normal bucketed variation. Variations are overwritten when [Set Forced Variation](doc:set-forced-variation-java) is invoked.
[block:callout]
{
  "type": "info",
  "title": "Note",
