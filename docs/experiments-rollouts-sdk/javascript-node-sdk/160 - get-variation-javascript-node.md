---
title: "Get Variation"
slug: "get-variation-javascript-node"
hidden: true
createdAt: "2019-09-12T15:00:36.538Z"
updatedAt: "2019-09-13T11:37:01.607Z"
---
...
[/block]
Takes the same arguments and returns the same values as [Activate](doc:activate-javascript-node), but without sending an impression network request. The behavior of the two methods is identical otherwise. 
...
Use Activate when the visitor actually sees the experiment. Use Get Variation when you need to know which bucket a visitor is in before showing the visitor the experiment. Impressions are tracked by [Is Feature Enabled](doc:is-feature-enabled-javascript-node) when there is a feature test running on the feature and the visitor qualifies for that feature test.
